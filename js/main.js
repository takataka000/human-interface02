    ...
    datasets: [
      {
        ...
        backgroundColor: ["#3B4BA6", "#3B4BA6", "#3B4BA6", "#3B4BA6", "#3B4BA6", "#3B4BA6", "#3B4BA6", "#3B4BA6", "#3B4BA6", "#3B4BA6"],
        borderWidth: 1,
      },
      {
        label: "平成29年",
        data: [
          ...
          46.7,
          20.1],
        backgroundColor: ["#64B8D9", "#64B8D9", "#64B8D9", "#64B8D9", "#64B8D9", "#64B8D9", "#64B8D9", "#64B8D9", "#64B8D9", "#64B8D9"],
        borderWidth: 1,
      },
      {
        label: "平成30年",
        data: [
          ...
          51.0,
          21.5],
        backgroundColor: ["#BFC24F", "#BFC24F", "#BFC24F", "#BFC24F", "#BFC24F", "#BFC24F", "#BFC24F", "#BFC24F", "#BFC24F", "#BFC24F"],
        borderWidth: 1,
      },
      {
        label: "令和元年",
        data: [89.8, 80.2, 98.4, 99.1, 99.0, 98.3, 97.7, 90.5, 74.2, 57.5],
        backgroundColor: ["#DBA76B", "#DBA76B", "#DBA76B", "#DBA76B", "#DBA76B", "#DBA76B", "#DBA76B", "#DBA76B", "#DBA76B", "#DBA76B"],
        borderWidth: 1,
      },
      {
        label: "令和2年４月",
        ...
        backgroundColor: ["#D16A59", "#D16A59", "#D16A59", "#D16A59", "#D16A59", "#D16A59", "#D16A59", "#D16A59", "#D16A59", "#D16A59"],
        borderWidth: 1,
      },
    ],
  },
    ...
    datasets: [
      {
        ...
        data: [
          ...
          9.6,
          1.4],
        backgroundColor: ["#02CDFF", "#02CDFF", "#02CDFF", "#02CDFF", "#02CDFF", "#02CDFF"],
        borderWidth: 1,
      },
      {
        label: "平成29年",
        data: [
          ...
          6.0,
          1.5],
        backgroundColor: ["#039EFF", "#039EFF", "#039EFF", "#039EFF", "#039EFF", "#039EFF"],
        borderWidth: 1,
      },
      {
        label: "平成30年",
        data: [
          ...
          4.6,
          1.7],
        backgroundColor: ["#0058FF", "#0058FF", "#0058FF", "#0058FF", "#0058FF", "#0058FF"],
        borderWidth: 1,
      },
      {
        label: "令和元年",
        data: [
          ...
          3.2,
          1.9],
        backgroundColor: ["#5902FF", "#5902FF", "#5902FF", "#5902FF", "#5902FF", "#5902FF"],
        borderWidth: 1,
      },
      {
        label: "令和2年",
        data: [
          ...
          2.5,
          1.3],
        backgroundColor: ["#8103FF", "#8103FF", "#8103FF", "#8103FF", "#8103FF", "#8103FF"],
        borderWidth: 1,
      },
    ],
  },
